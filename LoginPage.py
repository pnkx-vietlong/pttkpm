...
class LoginPage(object):
    ...
    def __init__(self, window):
        ...
        # ============================background image============================
        # ========================================================================
        self.bg_frame = Image.open('ImageFaceDetect\\background4.jpg')#khai báo biến bg_frame là ảnh background trong thư mục ImageFaceDetect\\background1.png
        ...
        self.lgn_frame = Frame(self.window, bg='#ffe4c4', width=950, height=600)
        ...
        # ======Hiện thị ngày====
        self.txt = today
        self.heading = Label(self.lgn_frame, text=self.txt, font=('times new roman', 25, "bold"), bg="#ffe4c4",
                             fg='white',
                             bd=5,
                             relief=FLAT)
        ...
        # ============ Left Side Image ================================================
        # ========================================================================
        self.side_image = Image.open('ImageFaceDetect\phenikaa_left_side.webp')
        photo = ImageTk.PhotoImage(self.side_image)
        self.side_image_label = Label(self.lgn_frame, image=photo, bg='#ffe4c4')
        ...
        self.sign_in_image_label = Label(self.lgn_frame, image=photo, bg='#ffe4c4')
        ...
        # ============ Sign In label =============================================
        # ========================================================================
        self.sign_in_label = Label(self.lgn_frame, text="Đăng nhập", bg="#ffe4c4", fg="blue",
        ...
        # ============================tài khoản====================================
        # ========================================================================
        self.username_label = Label(self.lgn_frame, text="Tài khoản", bg="#ffe4c4", fg="blue",
                                    font=("times new roman", 13, "bold"))
        self.username_label.place(x=550, y=300)

        self.txtuser = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg="#f5f5f5", fg="blue",
                                    font=("times new roman ", 12, "bold"),textvariable=self.var_email)
        self.txtuser.place(x=580, y=335, width=270)

        self.username_line = Canvas(self.lgn_frame, width=300, height=2.0, bg="#f5f5f5", highlightthickness=0)
        self.username_line.place(x=550, y=359)
        # ===== Username icon =========
        self.username_icon = Image.open('ImageFaceDetect\\username_icon.png')
        photo = ImageTk.PhotoImage(self.username_icon)
        self.username_icon_label = Label(self.lgn_frame, image=photo, bg='#ffe4c4')
        ...
        self.lgn_button_label = Label(self.lgn_frame, image=photo, bg='#ffe4c4')
        ...
        self.login = Button(self.lgn_button_label, text='Đăng nhập',command=self.login,
                            ...
                            bg='#3047ff', cursor='hand2', activebackground='#ffe4c4', fg='white')
        ...
        checkbtn = Checkbutton(self.lgn_frame, variable=self.varcheck,
                               font=("times new roman", 12), onvalue=1, offvalue=0 ,bg="#ffe4c4"
                                )
        checkbtn.place(x=550, y=510)

        self.check_label = Label(self.lgn_frame, text="Đăng nhập bằng tài khoản admin", bg="#ffe4c4", fg="blue",relief=FLAT,
        ...
        # ============================Mật khẩu====================================
        # ========================================================================
        self.password_label = Label(self.lgn_frame, text="Mật khẩu", bg="#ffe4c4", fg="blue",
                                    font=("times new roman", 13, "bold"))
        self.password_label.place(x=550, y=380)

        self.txtpass = Entry(self.lgn_frame, highlightthickness=0, relief=FLAT, bg="#f5f5f5", fg="blue",
                                    font=("times new roman", 12, "bold"), show="*",textvariable=self.var_password)
        self.txtpass.place(x=580, y=416, width=244)

        self.password_line = Canvas(self.lgn_frame, width=300, height=2.0, bg="#f5f5f5", highlightthickness=0)
        self.password_line.place(x=550, y=440)
        # ======== Password icon ================
        self.password_icon = Image.open('ImageFaceDetect\\password_icon.png')
        photo = ImageTk.PhotoImage(self.password_icon)
        self.password_icon_label = Label(self.lgn_frame, image=photo, bg='#ffe4c4')
